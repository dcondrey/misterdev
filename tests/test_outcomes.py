from misterdev.core.execution.outcomes import SKIP, GREEN, RED, GateOutcome
...
def test_gate_results_share_the_base_and_constants():
    ...
    from misterdev.core.verification.vision_verify import VisionResult
    from misterdev.core.execution.runtime import SmokeResult
    from misterdev.core.verification.mutation_gate import MutationResult
    from misterdev.core.verification.web_verify import WebResult
