...
RESPONSE as a task accumulates NON-INFRA (real code) failures, in order:
    ...
    normal -> widen_context -> stronger_model -> decompose
...
RUNGS = ("normal", "widen_context", "stronger_model", "decompose")
...
def choose_rung(
    ...
    *,
    ...
    wins, so misordered thresholds still yield a defined (monotonic) rung.
    """
