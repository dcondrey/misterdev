...
CATALOG: List[Dict[str, Any]] = [
    ...
    _e(
        ...
        "Sandboxed Linux VMs for code execution",
    ),
    _e(
        "git",
        "vcs",
    ...
    _e(
        ...
        "Official GitHub: PRs/issues/Actions/code search (Go/Docker)",
    ),
    _e(
        "context7",
        "docs",
    ...
    _e(
        ...
        "Cross-repo symbol search in the wild",
    ),
    _e(
        "kubernetes",
        "infra",
    ...
    _e(
        ...
        "Read/write pages, query databases (official)",
    ),
    _e(
        "mermaid",
        "diagram",
