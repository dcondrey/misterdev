...
When ``orchestrator.mcp_tool_use`` is on and an :class:`~my_project_orchestrator.core.integration.mcp.MCPManager`
...
Discipline mirrors :mod:`my_project_orchestrator.core.context.lsp` and
:mod:`my_project_orchestrator.core.integration.mcp`: every tool call is bounded (it goes
...
from my_project_orchestrator.core.integration.mcp import MCPManager
